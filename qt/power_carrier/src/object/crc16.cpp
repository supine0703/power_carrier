...
quint16 CRC16::ADD_XMODEM(QByteArray& bytes)
{
    quint16 crc16 = CRC16::XMODEM(bytes);
    bytes.append(crc16 >> 8);
    bytes.append(crc16 & 0xff);
    return crc16;
}
...
bool CRC16::CHECK_XMODEM(QByteArray& bytes)
{
    ...
    crc16 = (crc16 << 8) | static_cast<quint8>(bytes.at(len - 1));
    return crc16 == CRC16::XMODEM(bytes, -2);
}


quint16* CRC16::t1021 = new quint16[] {
